...
//		Bike b5 = new Bike("RX-135", 39863, "Yamaha", 78093, 2011, "Gold");
		...
		arr.add(new Bike("MT-50", 35623, "Yamaha", 10000, 2021, "Red"));
		arr.add(new Bike("Discover", 23568, "Bajaj", 80000, 2015, "Blue"));
		arr.add(new Bike("Platina", 39245, "Bajaj", 78225, 2021, "Grey"));
		arr.add(new Bike("Hf-delux", 32531, "Yamaha", 78093, 2019, "Black/Red"));
		arr.add(new Bike("Pulsor-220", 15000, "Bajaj", 78054, 2021, "Black/Red"));
